package com.example.activititest.config;
...
/**
 * 定义自己的ProcessDiagramGenerator 显示连线出文字  ：617行 变动处
 */
public class MyProcessDiagramGenerator implements ProcessDiagramGenerator {
    protected Map<Class<? extends BaseElement>, MyProcessDiagramGenerator.ActivityDrawInstruction> activityDrawInstructions;
    protected Map<Class<? extends BaseElement>, MyProcessDiagramGenerator.ArtifactDrawInstruction> artifactDrawInstructions;
    ...
    public MyProcessDiagramGenerator(final double scaleFactor) {
        ...
        this.activityDrawInstructions.put(StartEvent.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
        ...
        this.activityDrawInstructions.put(IntermediateCatchEvent.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ThrowEvent.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(EndEvent.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(Task.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(UserTask.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ScriptTask.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ServiceTask.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ReceiveTask.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(SendTask.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ManualTask.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(BusinessRuleTask.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ExclusiveGateway.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(InclusiveGateway.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ParallelGateway.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(EventGateway.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(BoundaryEvent.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(SubProcess.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(EventSubProcess.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                if (graphicInfo.getExpanded() != null && !graphicInfo.getExpanded()) {
        ...
        this.activityDrawInstructions.put(CallActivity.class, new MyProcessDiagramGenerator.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.artifactDrawInstructions.put(TextAnnotation.class, new MyProcessDiagramGenerator.ArtifactDrawInstruction() {
            @Override
        ...
        this.artifactDrawInstructions.put(Association.class, new MyProcessDiagramGenerator.ArtifactDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
                ...
                graphicInfoList = MyProcessDiagramGenerator.connectionPerfectionizer(processDiagramCanvas, bpmnModel, (BaseElement)sourceElement, (BaseElement)targetElement, graphicInfoList);
    ...
    protected void drawActivity(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode, List<String> highLightedActivities, List<String> highLightedFlows, double scaleFactor) {
        MyProcessDiagramGenerator.ActivityDrawInstruction drawInstruction = (MyProcessDiagramGenerator.ActivityDrawInstruction)this.activityDrawInstructions.get(flowNode.getClass());
        boolean highLighted;
...
//                }
    ...
    protected void drawArtifact(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
        MyProcessDiagramGenerator.ArtifactDrawInstruction drawInstruction = (MyProcessDiagramGenerator.ArtifactDrawInstruction)this.artifactDrawInstructions.get(artifact.getClass());
        if (drawInstruction != null) {
    ...
    public Map<Class<? extends BaseElement>, MyProcessDiagramGenerator.ActivityDrawInstruction> getActivityDrawInstructions() {
        return this.activityDrawInstructions;
    }

    public void setActivityDrawInstructions(Map<Class<? extends BaseElement>, MyProcessDiagramGenerator.ActivityDrawInstruction> activityDrawInstructions) {
        this.activityDrawInstructions = activityDrawInstructions;
    }

    public Map<Class<? extends BaseElement>, MyProcessDiagramGenerator.ArtifactDrawInstruction> getArtifactDrawInstructions() {
        return this.artifactDrawInstructions;
    }

    public void setArtifactDrawInstructions(Map<Class<? extends BaseElement>, MyProcessDiagramGenerator.ArtifactDrawInstruction> artifactDrawInstructions) {
